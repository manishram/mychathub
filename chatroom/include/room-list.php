...
<?php include('include/desktop-chat-box.php'); ?>
		...
		<div id="msg-input-div-2" class='box-header ' style='position:fixed;bottom:0;z-index:1000;padding:1px;background-color:#919696;width:100%;height:50px;box-shadow:0 -1px 2px rgba(0, 0, 0, 0.15), 0 -1px 0px rgba(0, 0, 0, 0.02) ;'><div class='row'>
