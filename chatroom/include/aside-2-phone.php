...
?> <div id="aside_2"  class="app-aside modal nav-dropdown">
    ...
    <div class="right navside white dk" style='width:80%;' data-layout="column">
      ...
      <div style="border-top: 2px solid #0cc2aa;" class="scroll" data-flex >
          <nav class="scroll nav-light">
           
        <div class="tab-content" >
          <div class="tab-pane animated fadeIn text-muted active" id="tab11" aria-expanded="false">
            <div class="box-body inner-box-overflow" style='padding:0px !important; overflow-x:hidden;height: calc(100vh - 55px);'>
	  ...
	  <div style="box-shadow:0px -1px 5px #c7c7c7;" class="nav-active-primary">
          <ul class="nav nav-tabs" style='width:100%;height:48px;z-index:0;overflow-x:auto;overflow-y:hidden;'>
            <li style='width:33.33%;' class="nav-item" >
			 ...
			 <center><i style='margin-top:5px; padding:0px;display:block' class='fas fa-users fa-lg'></i> 
...
<i style='margin-top:5px; padding:0px;display:block' class='fas fa-globe-asia fa-lg'></i>
<small style='font-size:80%;' class="text-muted text-ellipsis">Rooms</small>
</center></a>
            </li>
            <li style='width:33.33%;' class="nav-item">
              <a class="nav-link " style='height:48px;border-radius:0;' href="" data-toggle="tab" data-target="#tab13" aria-expanded="true"><center>
<i  style='margin-top:5px; padding:0px;display:block;display:block' class='fas fa-user-friends fa-lg'></i> 
